...
DATASET_PATH = "D:\deeplearning\dataset\extract\seabird3s"
...
train_ds = build_dataset(train_files, train_labels, "D:/deeplearning/python/train_cache.tf-data")
val_ds   = build_dataset(val_files, val_labels, "D:/deeplearning/python/val_cache.tf-data")
test_ds  = build_dataset(test_files, test_labels, "D:/deeplearning/python/test_cache.tf-data")
...
tflite_filename = f"seabird_model.tflite"
